    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-8" style="border: double;">
                ...
                <textarea name="title" style="width: 95%; height:35px;">${board.title}</textarea>
                <br><br>
                <p style="border: solid 1px gray;"></p>
                <br>
                <h4 style="font-weight: bold;">내용</h4>
                <textarea name="content" style="width: 95%; height: 300px;">${board.content}</textarea>
                <br><br><br>
                <input style="color:white; border:hidden;" name="contentno" readonly="readonly" value="${board.contentno}"/>
